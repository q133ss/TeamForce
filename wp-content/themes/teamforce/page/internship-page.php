        ...
        <nav class="breadcrumbs">
            <div class="_container">
                <ul class="breadcrumbs__items">
                    ...
                    <li class="breadcrumbs__item last"> 
                        <a class="breadcrumbs__link breadcrumbs__link-marked">Стажировка</a>
                    </li>
                </ul>
...
<section class="center-initial internship-initial">
    <img 
        src="<?php echo get_template_directory_uri(); ?>/img/internship-bg-first-mobile.png" 
        alt="internship-bg-first-mobile"
    ...
    <div class="center-initial__content _container">
        <div class="center-initial__left">
            <h1 class="center-initial__title _title-initial">
                <span class="_text-orange">Больше,</span> <br />
                чем просто стажировка
            </h1>
            <p class="center-initial__text _text-initial">
                Выбери направление бизнеса и получи <br /> реальный опыт на оплачиваемой стажировке
            </p>
        </div>
        <div class="center-initial__bg">
            <img 
                src="<?php echo get_template_directory_uri(); ?>/img/internship-bg-first.png" 
                alt="codex-initial-bg-first"
                class="center-initial__bg-first practice-initial__bg-desktop internship-initial__bg-first _centered" 
            />
            <img 
                src="<?php echo get_template_directory_uri(); ?>/img/center-circle-bg.png" 
                alt="resource-center-bg-first"
                class="center-initial__bg-circles practice-initial__bg-desktop" 
            />
        </div>
    </div>
</section>
    ...
    <div class="_container">
        <div class="practice-journey__content _grey-section__content">
            <h2 class="practice-journey__title journey-section__title _grey-section__title">
                Этапы отбора
            </h2>
            <ol class="internship-journey__grid journey-section__grid">
                <li class="journey-section__item journey-section__item-small">
